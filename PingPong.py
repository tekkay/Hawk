...
root = Tk()
root.title("Ping Pong 1.0 - Tekay teck")
root.resizable(0,0)
...
class Barra:
    def __init__(self, canvas, color):
        ...
        self.canvas.bind_all("<KeyPress-Left>", self.move_left) #Mover barra para esquerda
        self.canvas.bind_all("<KeyPress-Right>", self.move_right) #Mover barra para direita
...
def game_over():
    canvas.itemconfig(game, text="Você perdeu!")
